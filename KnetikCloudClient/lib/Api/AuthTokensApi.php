...
class AuthTokensApi
{
     ...
     * @return void
     */
    public function deleteToken($username, $client_id)
    {
        list($response) = $this->deleteTokenWithHttpInfo($username, $client_id);
        return $response;
    }
     ...
     */
    public function deleteTokenWithHttpInfo($username, $client_id)
    {
        // verify the required parameter 'username' is set
        if ($username === null) {
            throw new \InvalidArgumentException('Missing the required parameter $username when calling deleteToken');
        }
        // verify the required parameter 'client_id' is set
        if ($client_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $client_id when calling deleteToken');
        }
        // parse inputs
    ...
    {
        list($response) = $this->deleteTokensWithHttpInfo($username);
        return $response;
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteTokensWithHttpInfo($username)
    {
        // verify the required parameter 'username' is set
        if ($username === null) {
            throw new \InvalidArgumentException('Missing the required parameter $username when calling deleteTokens');
        }
        // parse inputs
        $resourcePath = "/auth/tokens/{username}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
