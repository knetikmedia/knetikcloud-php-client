...
class ReportingChallengesApi
{
     ...
     */
    public function getChallengeEventLeaderboard($filter_event = null)
    {
        list($response) = $this->getChallengeEventLeaderboardWithHttpInfo($filter_event);
        return $response;
    }
     ...
     */
    public function getChallengeEventLeaderboardWithHttpInfo($filter_event = null)
    {
        // parse inputs
     ...
     * @return \KnetikCloud\Model\PageResourceChallengeEventParticipantResource_
     */
    public function getChallengeEventParticipants($filter_event = null)
    {
        list($response) = $this->getChallengeEventParticipantsWithHttpInfo($filter_event);
        return $response;
    }
     ...
     * @return array of \KnetikCloud\Model\PageResourceChallengeEventParticipantResource_, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChallengeEventParticipantsWithHttpInfo($filter_event = null)
    {
        // parse inputs
