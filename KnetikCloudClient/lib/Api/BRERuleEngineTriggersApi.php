...
class BRERuleEngineTriggersApi
{
     ...
     */
    public function getBRETriggers($filter_system = null, $filter_category = null, $filter_name = null, $size = null, $page = null)
    {
        list($response) = $this->getBRETriggersWithHttpInfo($filter_system, $filter_category, $filter_name, $size, $page);
        return $response;
    }
     ...
     */
    public function getBRETriggersWithHttpInfo($filter_system = null, $filter_category = null, $filter_name = null, $size = null, $page = null)
    {
        // parse inputs
        $resourcePath = "/bre/triggers";
        $httpBody = '';
