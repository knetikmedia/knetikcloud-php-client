...
/**
 * Reporting_OrdersApi Class Doc Comment
 *
 * @category Class
 * @package  KnetikCloud
 * @author   Swagger Codegen team
...
class Reporting_OrdersApi
{
    ...
    {
        $returnType = '\KnetikCloud\Model\PageResourceAggregateInvoiceReportResource_';
        $request = $this->getInvoiceReportsRequest($currency_code, $granularity, $filter_payment_status, $filter_fulfillment_status, $start_date, $end_date, $size, $page);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\KnetikCloud\Model\PageResourceAggregateInvoiceReportResource_', $e->getResponseHeaders());
    ...
    /**
     * Operation getInvoiceReportsAsync
     *
     * Retrieve invoice counts aggregated by time ranges
     *
     * @param string $currency_code The code for a currency to get sales data for (required)
     ...
     */
    public function getInvoiceReportsAsync($currency_code, $granularity = 'day', $filter_payment_status = null, $filter_fulfillment_status = null, $start_date = null, $end_date = null, $size = '25', $page = '1')
    {
        return $this->getInvoiceReportsAsyncWithHttpInfo($currency_code, $granularity, $filter_payment_status, $filter_fulfillment_status, $start_date, $end_date, $size, $page)->then(function ($response) {
            return $response[0];
        });
    }

    /**
     * Operation getInvoiceReportsAsyncWithHttpInfo
     *
     * Retrieve invoice counts aggregated by time ranges
     *
     * @param string $currency_code The code for a currency to get sales data for (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvoiceReportsAsyncWithHttpInfo($currency_code, $granularity = 'day', $filter_payment_status = null, $filter_fulfillment_status = null, $start_date = null, $end_date = null, $size = '25', $page = '1')
    {
        $returnType = '\KnetikCloud\Model\PageResourceAggregateInvoiceReportResource_';
        $request = $this->getInvoiceReportsRequest($currency_code, $granularity, $filter_payment_status, $filter_fulfillment_status, $start_date, $end_date, $size, $page);
    ...
    /**
     * Create request for operation 'getInvoiceReports'
     *
     * @param string $currency_code The code for a currency to get sales data for (required)
     * @param string $granularity The time duration to aggregate by (optional, default to day)
     * @param string $filter_payment_status A payment status to filter results by, can be a comma separated list (optional)
     ...
     */
    protected function getInvoiceReportsRequest($currency_code, $granularity = 'day', $filter_payment_status = null, $filter_fulfillment_status = null, $start_date = null, $end_date = null, $size = '25', $page = '1')
    {
