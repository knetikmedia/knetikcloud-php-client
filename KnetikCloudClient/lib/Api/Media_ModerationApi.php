...
/**
 * Media_ModerationApi Class Doc Comment
 *
 * @category Class
 * @package  KnetikCloud
 * @author   Swagger Codegen team
...
class Media_ModerationApi
{
     ...
     */
    public function getModerationReports($exclude_resolved = 'true', $filter_context = null, $filter_context_id = null, $size = '25', $page = '1', $order = null)
    {
        list($response) = $this->getModerationReportsWithHttpInfo($exclude_resolved, $filter_context, $filter_context_id, $size, $page, $order);
        return $response;
    }
     ...
     */
    public function getModerationReportsWithHttpInfo($exclude_resolved = 'true', $filter_context = null, $filter_context_id = null, $size = '25', $page = '1', $order = null)
    {
        $returnType = '\KnetikCloud\Model\PageResourceFlagReportResource_';
        $request = $this->getModerationReportsRequest($exclude_resolved, $filter_context, $filter_context_id, $size, $page, $order);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getModerationReportsAsync($exclude_resolved = 'true', $filter_context = null, $filter_context_id = null, $size = '25', $page = '1', $order = null)
    {
        return $this->getModerationReportsAsyncWithHttpInfo($exclude_resolved, $filter_context, $filter_context_id, $size, $page, $order)->then(function ($response) {
            return $response[0];
        });
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getModerationReportsAsyncWithHttpInfo($exclude_resolved = 'true', $filter_context = null, $filter_context_id = null, $size = '25', $page = '1', $order = null)
    {
        $returnType = '\KnetikCloud\Model\PageResourceFlagReportResource_';
        $request = $this->getModerationReportsRequest($exclude_resolved, $filter_context, $filter_context_id, $size, $page, $order);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getModerationReportsRequest($exclude_resolved = 'true', $filter_context = null, $filter_context_id = null, $size = '25', $page = '1', $order = null)
    {
