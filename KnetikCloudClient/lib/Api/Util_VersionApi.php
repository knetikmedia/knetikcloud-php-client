...
/**
 * Util_VersionApi Class Doc Comment
 *
 * @category Class
 * @package  KnetikCloud
 * @author   Swagger Codegen team
...
class Util_VersionApi
{
    ...
    {
        $returnType = '\KnetikCloud\Model\Version';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\KnetikCloud\Model\Version', $e->getResponseHeaders());
    ...
    {
        return $this->getVersionAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
