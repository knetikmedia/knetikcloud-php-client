...
class BRERuleEngineActionsApi
{
     ...
     */
    public function getBREActions($filter_category = null, $filter_name = null)
    {
        list($response) = $this->getBREActionsWithHttpInfo($filter_category, $filter_name);
        return $response;
    }
     ...
     */
    public function getBREActionsWithHttpInfo($filter_category = null, $filter_name = null)
    {
        // parse inputs
