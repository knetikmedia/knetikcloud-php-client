...
class GamificationLeaderboardsApi
{
     ...
     */
    public function getLeaderboard($context_type, $context_id, $size = null, $page = null)
    {
        list($response) = $this->getLeaderboardWithHttpInfo($context_type, $context_id, $size, $page);
        return $response;
    }
     ...
     */
    public function getLeaderboardWithHttpInfo($context_type, $context_id, $size = null, $page = null)
    {
