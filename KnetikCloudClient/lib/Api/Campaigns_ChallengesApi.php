...
/**
 * Campaigns_ChallengesApi Class Doc Comment
 *
 * @category Class
 * @package  KnetikCloud
 * @author   Swagger Codegen team
...
class Campaigns_ChallengesApi
{
    ...
    {
        $this->updateChallengeActivityWithHttpInfo($id, $challenge_id, $challenge_activity_resource, $validate_settings);
    }
