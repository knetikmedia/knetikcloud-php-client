...
class ActivityResource implements ArrayAccess
{
    ...
    /**
     * Sets settings
     * @param \KnetikCloud\Model\AvailableSettingResource[] $settings The list of settings and their options available for this activity. Not populated when getting listing
     * @return $this
     */
