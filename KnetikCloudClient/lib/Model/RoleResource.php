 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RoleResource implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RoleResource';
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'role' => 'string',
        'role_permission' => '\KnetikCloud\Model\PermissionResource[]',
        'user_count' => 'int'
    ];
    ...
    /**
     * Sets client_count
     * @param int $client_count The number of clients this role is assigned to
     * @return $this
     */
    ...
    /**
     * Sets created_date
     * @param int $created_date The date the role was added. Unix timestamp in seconds
     * @return $this
     */
    ...
    /**
     * Sets locked
     * @param bool $locked Whether a role is locked from being deleted
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name The name of the role used for display purposes
     * @return $this
     */
    ...
    /**
     * Sets role
     * @param string $role The keyword that defines the role
     * @return $this
     */
     ...
     * @param \KnetikCloud\Model\PermissionResource[] $role_permission The list of permissions this role has
     * @return $this
     */
    ...
    /**
     * Sets user_count
     * @param int $user_count The number of users this role is assigned to
     * @return $this
     */
