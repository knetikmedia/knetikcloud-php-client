...
class ActivityOccurrenceResource implements ArrayAccess
{
    ...
    /**
     * Sets settings
     * @param \KnetikCloud\Model\SelectedSettingResource[] $settings The list of settings and their options available for this activity. Should be null on create if and only if part of an event. Otherwise, the set must exactly match those of the activity.
     * @return $this
     */
    ...
    /**
     * Sets simulated
     * @param bool $simulated Whether this occurrence will be played as a simulation.
     * @return $this
     */
    ...
    /**
     * Sets users
     * @param \KnetikCloud\Model\ActivityUserResource[] $users The list of users playing in this occurrence. Can only be set directly with ACTIVITIES_ADMIN permission
     * @return $this
     */
