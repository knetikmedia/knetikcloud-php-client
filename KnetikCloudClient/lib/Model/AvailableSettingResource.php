...
class AvailableSettingResource implements ArrayAccess
{
    ...
    /**
     * Sets default_value
     * @param string $default_value The value of the default option (must be in options array)
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string $name The textual name of the setting
     * @return $this
     */
    ...
    /**
     * Sets options
     * @param \KnetikCloud\Model\SettingOption[] $options The set of options available for this setting
     * @return $this
     */
