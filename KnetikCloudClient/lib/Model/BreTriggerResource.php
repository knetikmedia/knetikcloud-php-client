...
class BreTriggerResource implements ArrayAccess
{
    ...
    /**
     * Sets parameters
     * @param \KnetikCloud\Model\BreTriggerParameterDefinition[] $parameters A list af parameters that will be sent with the event when the trigger is fired. These must be included in the event and match the described types
     * @return $this
     */
