...
/**
 * BreTriggerParameterDefinition Class Doc Comment
 *
 * @category    Class
 * @package     KnetikCloud
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BreTriggerParameterDefinition implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BreTriggerParameterDefinition';
    ...
    /**
     * Sets name
     * @param string $name The name of the parameter. This is used as the unique identifier of this parameter
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type The variable type of this parameter. See Bre Variables endpoint for list
     * @return $this
     */
