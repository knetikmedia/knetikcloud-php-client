...
/**
 * CoreChallengeActivitySettings Class Doc Comment
 *
 * @category    Class
 * @package     KnetikCloud
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CoreChallengeActivitySettings implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CoreChallengeActivitySettings';
    ...
    /**
     * Sets boot_in_play
     * @param bool $boot_in_play Whether the host can boot a user while the status is PLAYING. Null to inherit from activity
     * @return $this
     */
     ...
     * @param string $custom_launch_address A custom address (url, ip or whatever is needed in your game) that users should connect to to play in this challenge rather than the usual game server. Max length: 255
     * @return $this
     */
     ...
     * @param bool $custom_launch_address_allowed Restriction for whether the host creating an occurrence can specify a custom launch address (such as their own ip address). Will override the challenge's custom_launch_address if they do. Null to inherit from activity
     * @return $this
     */
    ...
    /**
     * Sets host_option
     * @param string $host_option Restriction for who can host an occurrence. admin disallows regular users, player means the user must also be a player in the occurrence if not admin, non-player means the user has the option to host without being a player. Null to inherit
     * @return $this
     */
     ...
     * @param bool $host_status_control Restriction for whether the host has control of the status once the game launches. If false they can only manage the game before (when setup and open). Max length: 255. Null to inherit from activity
     * @return $this
     */
    ...
    /**
     * Sets join_in_play
     * @param bool $join_in_play Whether users can join while the status is PLAYING. Null to inherit from activity
     * @return $this
     */
    ...
    /**
     * Sets leave_in_play
     * @param bool $leave_in_play Whether users can leave while the status is PLAYING. Null to inherit from activity
     * @return $this
     */
    ...
    /**
     * Sets max_players
     * @param int $max_players The maximum number of players the game can hold. Null to inherit from activity
     * @return $this
     */
    ...
    /**
     * Sets min_players
     * @param int $min_players The minimum number of players the game can hold. Null to inherit from activity
     * @return $this
     */
    ...
    /**
     * Sets results_trust
     * @param string $results_trust Restriction for who is able to report game end and results. Admin is always able to send results as well. Null to inherit from activity
     * @return $this
     */
