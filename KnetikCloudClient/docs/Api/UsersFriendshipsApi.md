...
# **getFriends**
> \KnetikCloud\Model\PageResourceSimpleUserResource_ getFriends($user_id, $size, $page, $order)
...
try {
    $result = $api_instance->getFriends($user_id, $size, $page, $order);
    print_r($result);
} catch (Exception $e) {
...
# **getInvites**
> \KnetikCloud\Model\PageResourceSimpleUserResource_ getInvites($user_id, $size, $page, $order)
...
try {
    $result = $api_instance->getInvites($user_id, $size, $page, $order);
    print_r($result);
} catch (Exception $e) {
