# KnetikCloud\Rule_Engine_TriggersApi
...
$api_instance = new KnetikCloud\Api\Rule_Engine_TriggersApi(new \Http\Adapter\Guzzle6\Client());
...
try {
    ...
    echo 'Exception when calling Rule_Engine_TriggersApi->createBRETrigger: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Rule_Engine_TriggersApi->deleteBRETrigger: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Rule_Engine_TriggersApi->getBRETrigger: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Rule_Engine_TriggersApi->getBRETriggers: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Rule_Engine_TriggersApi->updateBRETrigger: ', $e->getMessage(), PHP_EOL;
}
?>
```
