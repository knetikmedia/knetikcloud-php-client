...
# **getLeaderboard**
> \KnetikCloud\Model\LeaderboardResource getLeaderboard($context_type, $context_id, $size, $page)
...
try {
    $result = $api_instance->getLeaderboard($context_type, $context_id, $size, $page);
    print_r($result);
} catch (Exception $e) {
