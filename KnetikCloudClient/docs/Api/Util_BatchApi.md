...
$api_instance = new KnetikCloud\Api\Util_BatchApi(new \Http\Adapter\Guzzle6\Client());
...
try {
    ...
    echo 'Exception when calling Util_BatchApi->getBatch: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Util_BatchApi->sendBatch: ', $e->getMessage(), PHP_EOL;
}
?>
```
