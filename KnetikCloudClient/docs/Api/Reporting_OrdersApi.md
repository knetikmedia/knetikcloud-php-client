# KnetikCloud\Reporting_OrdersApi
...
$api_instance = new KnetikCloud\Api\Reporting_OrdersApi(new \Http\Adapter\Guzzle6\Client());
...
try {
    ...
    echo 'Exception when calling Reporting_OrdersApi->getInvoiceReports: ', $e->getMessage(), PHP_EOL;
}
?>
```
