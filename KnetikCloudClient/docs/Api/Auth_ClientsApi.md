...
$api_instance = new KnetikCloud\Api\Auth_ClientsApi(new \Http\Adapter\Guzzle6\Client());
...
try {
    ...
    echo 'Exception when calling Auth_ClientsApi->createClient: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Auth_ClientsApi->deleteClient: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Auth_ClientsApi->getClient: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Auth_ClientsApi->getClientGrantTypes: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Auth_ClientsApi->getClients: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Auth_ClientsApi->setClientGrantTypes: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Auth_ClientsApi->setClientRedirectUris: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Auth_ClientsApi->updateClient: ', $e->getMessage(), PHP_EOL;
}
?>
```
