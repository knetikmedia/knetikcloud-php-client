# KnetikCloud\Payments_WalletsApi
...
$api_instance = new KnetikCloud\Api\Payments_WalletsApi(new \Http\Adapter\Guzzle6\Client());
...
try {
    ...
    echo 'Exception when calling Payments_WalletsApi->getUserWallet: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Payments_WalletsApi->getUserWalletTransactions: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Payments_WalletsApi->getUserWallets: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Payments_WalletsApi->getWalletBalances: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Payments_WalletsApi->getWalletTransactions: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Payments_WalletsApi->getWallets: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
try {
    ...
    echo 'Exception when calling Payments_WalletsApi->updateWalletBalance: ', $e->getMessage(), PHP_EOL;
}
?>
```
