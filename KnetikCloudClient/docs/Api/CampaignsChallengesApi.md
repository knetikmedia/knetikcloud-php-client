...
# **getChallenges**
> \KnetikCloud\Model\PageResourceChallengeResource_ getChallenges($filter_template, $filter_active_campaign)
...
try {
    $result = $api_instance->getChallenges($filter_template, $filter_active_campaign);
    print_r($result);
} catch (Exception $e) {
