...
# **getBRETriggers**
> \KnetikCloud\Model\PageResourceBreTriggerResource_ getBRETriggers($filter_system, $filter_category, $filter_name, $size, $page)
...
try {
    $result = $api_instance->getBRETriggers($filter_system, $filter_category, $filter_name, $size, $page);
    print_r($result);
} catch (Exception $e) {
